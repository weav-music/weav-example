...
class WeavMusicSessionListenerImpl : WeavMusicSessionListener{
    ...
    private var playPauseButton: ImageView
    var playing: Boolean = false

    constructor(seekBar: SeekBar, songImage: ImageView, songTitle: TextView, songArtist: TextView, playPauseButton: ImageView) {
    ...
    override fun playerStateChanged(isPlaying: Boolean) {
        ...
        if (isPlaying) {
            ...
            playPauseButton.setImageResource(R.drawable.ic_baseline_play_arrow_24dp)
        }
    }
